            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                >
                    {techStack.map((tech, index) => (
                        ...
                        >
                            <div className="w-10 h-10 flex items-center justify-center text-gray-400 group-hover:text-gray-600 transition-colors duration-300">
                                <tech.icon />
                            </div>
                            <span className="text-sm font-medium text-gray-400 group-hover:text-gray-600 transition-colors duration-300">
                                {tech.name}
                            </span>
                        </motion.div>
                    ))}
