            ...
            <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-20 lg:py-32">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        >
                            {t('headline1')}{' '}
                            <span className="text-[#5D3FD3]">{t('headline2')}</span>
                        </motion.h1>
                            ...
                            <div className="relative w-[280px] md:w-[320px] bg-gray-900 rounded-[3rem] p-3 shadow-2xl shadow-gray-900/20">
                                ...
                                <div className="bg-white rounded-[2.5rem] overflow-hidden">
                                    ...
                                    <div className="px-5 pb-6 bg-gradient-to-b from-white to-gray-50">
                                        ...
                                        {/* Score Card */}
                                        <div className="bg-gradient-to-br from-[#5D3FD3] to-[#6366F1] rounded-2xl p-5 mb-4 text-white">
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            ...
                                            <div className="bg-white rounded-xl p-3 shadow-sm border border-gray-100">
                                                ...
                                                <p className="text-xl font-bold text-[#5D3FD3]">{t('low')}</p>
                                            </div>
                                            <div className="bg-white rounded-xl p-3 shadow-sm border border-gray-100">
